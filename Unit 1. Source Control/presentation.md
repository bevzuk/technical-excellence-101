...
1. Затяните последние изменения
    * *git pull*
2. Посмотрите список всех веток
    * *git branch -a*
3. Переключитесь в ветку master
    * *git checkout master*
4. Откройте сказку и убедитесь, что ваших изменений нет. Не паникуйте.
5. Переключитесь обратно в вашу ветку
    * *git checkout <имя ветки>*
6. Откройте сказку и убедитесь, что ваши изменения на месте. Выдохните.
